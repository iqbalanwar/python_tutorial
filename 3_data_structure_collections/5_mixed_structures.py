'''
In python, everything is an object, and variables store references
to objects. This means you can store anything in a data structure.
This means an object can reference other objects (even class objects
that you created). This allows you to create virtually any structured
data.
'''
